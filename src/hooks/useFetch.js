        ...
        const fetchData = async (settingStateFunction, fetchParameters, fetchSecoundTime) => {
            ...
            switch (fetchingFrom) {
                case "forexToForex":
                    ...
                    break;
                case "forexToCrypto":
                    link = `https://cors-anywhere.herokuapp.com/http://api.coinlayer.com/live?access_key=${currentKeyCoinLayer}&symbols=${selectedSecoundOption.value}&target=${selectedFirstOption.value}`;
                    break;
                case "cryptoToCrypto":
                    link = `https://cors-anywhere.herokuapp.com/http://api.coinlayer.com/live?access_key=${currentKeyCoinLayer}&symbols=${fetchParameters.value}&target=USD`;
                    break;
                case "stockToForex":
